...
public class UIManager : MonoBehaviour
{
    ...
    public GameObject keyBindingsWindow; // in-game keys
    ...
    void Start()
    {
        ...
        quickSlotsUI.UpdateCurrentConsumableItem(playerInventory.currentConsumable);
    ...
    public void RestartGame(){
        ...
        SceneManager.LoadScene(scene.name);
         // wait a frame, so it can finish loading
