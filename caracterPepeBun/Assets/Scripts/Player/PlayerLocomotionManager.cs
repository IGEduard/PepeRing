...
public class PlayerLocomotionManager : MonoBehaviour
{
    ...
    public void HandleMovement(float delta){
        ...
        if (inputHandler.sprintFlag && inputHandler.moveAmout > 0.5){
            speed = sprintSpeed;
            playerManager.isSprinting = true;
            moveDirection *= speed;
            playerStatsManager.TakeStaminaDamage(sprintStaminaCost);
        } else {
            if(inputHandler.moveAmout < 0.5){
        ...
        if (inputHandler.lockOnFlag && inputHandler.sprintFlag == false){
            ...
            //playerAnimatorManager.UpdateAnimatorValues(inputHandler.moveAmout, 0, playerManager.isSprinting);
